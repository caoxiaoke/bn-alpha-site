...
export const translations = {
  zh: {
    ...
    copy: '复制',
    copied: '已复制',
    viewBscscan: '查看 BscScan',
    dataUnavailable: '暂无数据',
    perpCheckUnavailable: '合约校验接口受限（上游限制），无法仅展示合约代币',
    vmc: '成交/市值比',
    funding: '费率',
    raveScore: '妖币得分',
    perp: '合约',
  ...
  en: {
    ...
    perpCheckUnavailable: 'Perpetual validation is restricted upstream; cannot show perp-only tokens',
    vmc: 'V/MC',
    funding: 'Funding',
